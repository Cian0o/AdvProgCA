...
con.execute("create table pharmaValidate (PSIReg INTEGER PRIMARY KEY, Trading Name TEXT, Street1 TEXT, Street2 TEXT, Street3 TEXT, Town TEXT, County TEXT, RPB Owner TEXT, Eircode TEXT, Address1 TEXT)")
